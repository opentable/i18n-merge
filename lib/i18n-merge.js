...
var orderLanguageListAndGetCodes = function(languages, autoFallback) {
...
var languageLocator = function(switchedObj) {
    return getLanguageId(switchedObj.Language.Code, switchedObj.Language.Region);
}
